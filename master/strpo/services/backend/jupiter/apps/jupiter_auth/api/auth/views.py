...
from jupiter_auth.api.auth.serializers import (
    PasswordResetSerializer, SignInSerializer,
    SignUpSerializer
)
from jupiter_auth.api.users.serializers import UserSerializer
from jupiter_auth.authentication import TokenAuthentication, sign_in, sign_out
...
class PasswordResetView(GenericViewSet):
    ...
    def reset(self, request, *args, **kwargs):
        ...
        try:
            send_mail('no-reply@jupiter.com', user.email, 'Восстановление пароля', message)
