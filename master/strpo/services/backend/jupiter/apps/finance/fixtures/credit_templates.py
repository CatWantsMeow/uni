...
CREDIT_TEMPLATES = [
    {
        ...
        "detailed_info": "Кредитный продукт, на базе которого вы выбираете "
                         ...
                         "Вы можете оформить кредит онлайн, после чего заявку рассмотрит "
                         "администратор. "
                         "Деньги могут быть переведены на указанный вами счет либо получены "
                         "наличными, при этом "
...

    {
        ...
        "detailed_info": "Выдача производится онлайн. "
                         ...
                         "Выдается только в BYN. Деньги переводятся на указанный вами расчетный "
                         "счет. "
...

    {
        ...
        "detailed_info": "Максимальная и минимальная сумма кредиты определяются "
                         ...
                         "В случае выбора поручительства, вам следует посетить банк на следующий "
                         "календарный день "
