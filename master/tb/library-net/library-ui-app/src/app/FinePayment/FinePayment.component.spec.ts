...
describe('FinePaymentComponent', () => {
  ...
  let mockFinePaymentService;
  let mockDataService

  beforeEach(async(() => {

    mockFinePaymentService = sinon.createStubInstance(FinePaymentService);
    mockFinePaymentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: FinePaymentService, useValue: mockFinePaymentService },
